export default defineNuxtConfig({
  ...
  i18n: {
    ...
    langDir: 'locales',
    locales: [
      { code: 'ar', language: 'ar-AE', name: 'العربية', dir: 'rtl', file: 'ar.json' },
      ...
      preprocessorOptions: {
        scss: {
          ...
          additionalData(content, filename) {
            ...
            if (file.includes('assets/scss/main.scss') || file.includes('assets/scss/_mixins.scss')) {
              return content
            }
  ...
  app: {
    ...
    head: {
      ...
      meta: [
        ...
        { name: 'description', content: 'Modern social marketplace for buying, selling, and auctioning products.' },
      ],
      link: [
